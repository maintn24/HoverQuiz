...
namespace MaterialUI
{
	...
	public class EZAnimEditor : Editor
	{
		...
		private string[] FindComponentStrings(UnityEngine.GameObject targetGameObject)
		{
		...
		private string[] FindMethodStrings(UnityEngine.GameObject targetGameObject, string targetComponent)
		{
		...
		private string[] FindVariableStrings(UnityEngine.GameObject targetGameObject, string targetComponent)
		{
		...
		void ConfigureStruct(int index)
		{
            ...
            tempStruct.targetGameObject = (UnityEngine.GameObject)EditorGUILayout.ObjectField("Target GameObject", tempStruct.targetGameObject, typeof(UnityEngine.GameObject), true);
				...
				if (tempStruct.methodOnEnd)
				{
                    ...
                    tempStruct.methodTargetGameObject =
						(UnityEngine.GameObject)
                            EditorGUILayout.ObjectField("Target GameObject", tempStruct.methodTargetGameObject, typeof (UnityEngine.GameObject), true);
