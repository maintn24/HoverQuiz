...
namespace MaterialUI
{
	...
	{
		static UnityEngine.GameObject theToast;
		...
		{
            theToast = Resources.Load("Toast", typeof(UnityEngine.GameObject)) as UnityEngine.GameObject;
		...
		public static void MakeToast (string content, float duration, Color panelColor, Color textColor, int fontSize)
		{
            ...
            UnityEngine.GameObject.Instantiate(theToast);
		}
	}
}