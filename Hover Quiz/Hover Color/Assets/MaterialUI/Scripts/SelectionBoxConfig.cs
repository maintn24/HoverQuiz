...
namespace MaterialUI
{
	public class SelectionBoxConfig : MonoBehaviour
	{
		...
		public UnityEngine.GameObject listLayer;
        ...
        UnityEngine.GameObject[] listItemObjects;
		float listheight;
		...
		Button thisButton;
        UnityEngine.GameObject listItemPrefab;
        UnityEngine.GameObject listItem;
		...
		void Start ()
		{
            ...
            listItemPrefab = Resources.Load("SelectionListItem", typeof(UnityEngine.GameObject)) as UnityEngine.GameObject;
			Setup ();
		}
		...
		public void Setup ()
		{
            ...
            listItemObjects = new UnityEngine.GameObject[listItems.Length];

			for (int i = 0; i < listItems.Length; i++)
			{
                listItem = Instantiate(listItemPrefab) as UnityEngine.GameObject;
